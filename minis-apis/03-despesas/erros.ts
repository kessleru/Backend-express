...
// "não existe" e não "não encontrado": os dois recursos desta API são
// femininos (categoria, despesa) e a fábrica é uma só. Mensagem que concorda
// com qualquer gênero evita ter duas fábricas ou um texto errado.
