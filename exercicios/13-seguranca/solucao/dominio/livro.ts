...
export type FiltroLivros = {
  /**
   * Busca por trecho do título. Entrou no módulo 13 por ser o campo de texto
   * livre mais exposto de qualquer API — e o que mais leva injeção quando o
   * repositório fala SQL.
   */
  q?: string | undefined;
  autorId?: number | undefined;
